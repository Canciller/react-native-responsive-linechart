...
var Chart = React.memo(React.forwardRef(function (props, ref) {
    var propsCopy = React.useMemo(function () {
        var copy = __assign({}, props);
        delete copy.scrollViewRef;
        return copy;
    }, [props]);
    var _a = deepmerge_1.default(computeDefaultProps(propsCopy), propsCopy), style = _a.style, children = _a.children, _b = _a.data, data = _b === void 0 ? [] : _b, padding = _a.padding, xDomain = _a.xDomain, yDomain = _a.yDomain, viewport = _a.viewport, disableGestures = _a.disableGestures, disableTouch = _a.disableTouch;
    ...
    return (React.createElement(react_native_1.View, { style: style, onLayout: onLayout },
        React.createElement(react_native_gesture_handler_1.GestureHandlerRootView, null, !!dimensions && (React.createElement(react_native_gesture_handler_1.TapGestureHandler, { enabled: !disableTouch, onHandlerStateChange: _onTouchGestureEvent, ref: tapGesture },
            React.createElement(react_native_1.Animated.View, { style: { width: dimensions.width, height: dimensions.height } },
                React.createElement(react_native_gesture_handler_1.PanGestureHandler, { enabled: !disableGestures, minDeltaX: 10, minDeltaY: 10, onGestureEvent: _onPanGestureEvent, onHandlerStateChange: _onPanGestureEvent, ref: panGesture, simultaneousHandlers: props.scrollViewRef },
                    React.createElement(react_native_1.Animated.View, { style: { width: dimensions.width, height: dimensions.height } },
